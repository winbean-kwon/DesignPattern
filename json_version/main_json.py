import os
from rent_json import RentalServiceFacade
from return_car_json import RentalReturnProcessor, LateReturnFeeStrategy, CardPaymentStrategy, AccountPaymentStrategy, PayPaymentStrategy
from customer_singleton_json import Customer
